...
def analyze(
    ...
    risk: Annotated[
        list[str] | None,
        typer.Option("--risk", help="Filtra niveis de risco: baixo, medio, alto."),
    ] = None,
    sort_by: Annotated[
        str,
        typer.Option("--sort-by", help="Ordena por: score, commits, complexity ou churn."),
    ] = "score",
...
def hotspots(
    ...
    sort_by: Annotated[str, typer.Option("--sort-by")] = "score",
